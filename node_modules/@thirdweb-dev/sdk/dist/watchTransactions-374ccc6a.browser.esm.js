import { b3 as getSignerAndProvider, aM as resolveAddress, al as getCompositeABI, bj as AbiSchema, j as getContractTypeForRemoteName, h as PREBUILT_CONTRACTS_MAP } from './index-d6a13f98.browser.esm.js';
...
async function getContractFromAbi(params) {
  ...
  const [resolvedAddress, {
    ...
    SmartContract
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./smart-contract-d84e779e.browser.esm.js')]);
...
async function getContract(params) {
  ...
  const [resolvedAddress, {
    ...
    ContractPublisher
  }] = await Promise.all([resolveAddress(params.address), provider.getNetwork(), import('./contract-publisher-d11e3095.browser.esm.js').then(function (n) { return n.c; })]);
  if (inContractCache(resolvedAddress, chainId)) {
    return getCachedContract(resolvedAddress, chainId);
  }
