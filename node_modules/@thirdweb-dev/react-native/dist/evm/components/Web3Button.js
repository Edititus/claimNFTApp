 ...
 * @beta
 */
export const Web3Button = ({ contractAddress, onSuccess, onError, onSubmit, isDisabled, contractAbi, children, action, theme, connectWalletProps, }) => {
    ...
    return (<ThemeProvider>
      <BaseButton backgroundColor="buttonBackgroundColor" onPress={() => {
            actionMutation.mutate();
        }} style={styles.actionButton} disabled={buttonDisabled || buttonLoading}>
        {typeof content === "string" ? (<Text variant="bodyLarge" color="buttonTextColor">
            {content}
          </Text>) : (content)}
      </BaseButton>
    </ThemeProvider>);
