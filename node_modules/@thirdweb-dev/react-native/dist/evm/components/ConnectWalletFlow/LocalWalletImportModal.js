...
export const LocalWalletImportModal = ({ isVisible, onClose, onWalletImported, }) => {
    const l = useLocale();
    const [password, setPassword] = useState();
    const [privateKeyOrMnemonic, setPrivateKeyOrMnemonic] = useState(undefined);
    ...
    const onPrivateKeyEntered = (text) => {
        setPrivateKeyOrMnemonic(text);
    };
    return (<TWModal isVisible={isVisible} backdropOpacity={0.7}>
      <KeyboardAvoidingView behavior="padding">
        <Box flexDirection="column" backgroundColor="background" borderRadius="md" p="lg">
          <ModalHeaderTextClose headerText={"Import JSON Wallet"} onClose={onCloseInternal}/>
          <Text variant="subHeader" mt="md" textAlign="center">
            {l.local_wallet.application_can_authorize_transactions}
          </Text>
          <BaseButton backgroundColor="background" borderColor="border" mt="lg" onPress={onPickFilePress} style={styles.pkButton}>
          ...
          <Box mb="xs" flexDirection="row" justifyContent="center" alignItems="center">
          ...
          <Box flexDirection="row" justifyContent="center" paddingHorizontal="md" mt="lg">
            <BaseButton backgroundColor="white" style={styles.modalButton} onPress={onImportPress}>
              {isImporting ? (<ActivityIndicator size="small" color="buttonTextColor"/>) : (<Text variant="bodySmall" color="black">
                  {l.common.import}
                </Text>)}
            </BaseButton>
          </Box>
