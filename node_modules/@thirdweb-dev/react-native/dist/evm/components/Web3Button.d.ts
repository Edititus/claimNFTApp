 ...
 * @beta
 */
export declare const Web3Button: <TAction extends ActionFn>({ contractAddress, onSuccess, onError, onSubmit, isDisabled, contractAbi, children, action, theme, connectWalletProps, }: PropsWithChildren<Web3ButtonProps<TAction>>) => import("react").JSX.Element;
export {};
