export const _en = {
    ...
    connect_wallet_details: {
        ...
        copy_address_or_scan: "Copy the wallet address or scan the QR code to send funds to this wallet.",
        ...
        network_mismatch: "There's a network mismatch between your contract and your wallet",
    },
    connecting_wallet: {
        creating_encrypting: "Creating, encrypting and securing your device wallet.",
        connecting_your_wallet: "Connecting your wallet",
        connecting_through_pop_up: "Login and connect your app through the wallet pop-up",
    },
    local_wallet: {
        ...
        application_can_authorize_transactions: "The application can authorize any transactions on behalf of the wallet without any approvals. We recommend only connecting to trusted applications.",
        ...
        this_will_download_json: "This will download a JSON file containing your wallet information onto your device encrypted with the password.",
        this_is_a_temporary_wallet: "This is a temporary guest wallet. Download a backup if you don't want to loose access to it.",
    },
    smart_wallet: {
