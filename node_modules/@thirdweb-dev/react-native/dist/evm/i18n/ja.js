export const _ja = {
    ...
    connect_wallet_details: {
        ...
        copy_address_or_scan: "ウォレットのアドレスをコピーするか、QRコードをスキャンして資金をこのウォレットに送信します",
        ...
        switch_to: "に切り替える",
        no_supported_chains_detected: "サポートされているチェーンが検出されませんでした",
        recommended: "推奨",
        network_mismatch: "あなたのコントラクトとウォレットの間にネットワークの不一致があります",
    },
    connecting_wallet: {
        creating_encrypting: "デバイスのウォレットを作成、暗号化、保護しています",
        connecting_your_wallet: "ウォレットを接続しています",
        connecting_through_pop_up: "ウォレットのポップアップを通じてアプリにログインして接続します",
    },
    local_wallet: {
        ...
        application_can_authorize_transactions: "アプリケーションは、承認なしにウォレットを代わりにトランザクションを許可することができます　信頼できるアプリケーションのみに接続することをおすすめします",
        double_check_password: "パスワードまたは秘密鍵を再度確認してください",
        error_accessing_file: "ファイルにアクセスできませんでしたもう一度試してください",
        wallet_address: "ウォレットのアドレス",
        this_will_download_json: "これにより、パスワードで暗号化されたウォレット情報を含むJSONファイルがデバイスにダウンロードされます",
        this_is_a_temporary_wallet: "これは一時的なゲストウォレットです　アクセスを失わないようにバックアップをダウンロードしてください",
    },
    smart_wallet: {
