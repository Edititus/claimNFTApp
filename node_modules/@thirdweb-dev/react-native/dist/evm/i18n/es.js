export const _es = {
    ...
    connect_wallet_details: {
        ...
        copy_address_or_scan: "Copia la dirección de la cartera o escanea el código QR para enviar fondos a esta cartera.",
    ...
    connecting_wallet: {
        creating_encrypting: "Creando, cifrando y asegurando tu cartera de dispositivo.",
        connecting_your_wallet: "Conectando tu cartera",
        connecting_through_pop_up: "Iniciar sesión y conectar tu aplicación a través del pop-up de la cartera",
    },
    local_wallet: {
        ...
        application_can_authorize_transactions: "La aplicación puede autorizar cualquier transacción en nombre de la cartera sin aprobaciones. Recomendamos conectar solo a aplicaciones de confianza.",
        double_check_password: "Por favor, verifica tu contraseña o clave privada.",
        error_accessing_file: "Error al acceder al archivo. Por favor, inténtalo de nuevo.",
        wallet_address: "Dirección de la Cartera",
        this_will_download_json: "Esto descargará un archivo JSON que contiene la información de tu cartera en tu dispositivo cifrada con la contraseña.",
        this_is_a_temporary_wallet: "Esta es una cartera de invitado temporal. Descarga un respaldo si no quieres perder el acceso a ella.",
    },
    smart_wallet: {
    ...
    embedded_wallet: {
        ...
        set_password_message: "Establece una contraseña para tu cuenta. Necesitarás esta contraseña cuando te conectes desde un nuevo dispositivo.",
