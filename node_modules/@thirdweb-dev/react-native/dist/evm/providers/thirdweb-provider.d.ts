...
interface ThirdwebProviderProps<TChains extends Chain[]> extends Omit<ThirdwebProviderCoreProps<TChains>, "supportedWallets" | "secretKey" | "signer"> {
    /**
...
export declare const ThirdwebProvider: <TChains extends Chain[] = ({
    ...
    readonly testnet: true;
})[]>({ children, createWalletStorage, supportedWallets, authConfig, theme, storageInterface, clientId, sdkOptions, locale, ...restProps }: PropsWithChildren<ThirdwebProviderProps<TChains>>) => import("react").JSX.Element;
export {};
