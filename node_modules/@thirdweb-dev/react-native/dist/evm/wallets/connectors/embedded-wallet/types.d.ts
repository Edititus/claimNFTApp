...
import { AuthProvider, RecoveryShareManagement, UserWalletStatus, WalletOptions } from "@thirdweb-dev/wallets";
...
export type EmbeddedWalletOptions = Omit<WalletOptions<EmbeddedConnectorOptions>, "clientId">;
...
export type AuthParams = EmailVerificationAuthParams | GoogleAuthParams | JwtAuthParams;
