export declare function getConnectedEmail(): string | undefined;
export declare function saveConnectedEmail(email: string): void;
export declare function clearConnectedEmail(): void;
export declare function isDeviceSharePresentForUser(clientId: string, walletUserId?: string): Promise<boolean>;
export declare function getAuthTokenClient(clientId: string): Promise<string | undefined>;
